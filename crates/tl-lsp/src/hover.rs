...
mod tests {
    ...
    fn test_hover_on_builtin() {
        ...
        if let HoverContents::Markup(content) = &hover.contents {
            assert!(
                content.value.contains("fn print"),
                "Should show builtin signature"
            );
    ...
    fn test_hover_undocumented_still_works() {
        ...
        if let HoverContents::Markup(content) = &hover.contents {
            ...
            assert!(
                ...
                "Should NOT have separator when no doc"
            );
        }
    }
    ...
    fn test_hover_documented_let() {
        ...
        if let HoverContents::Markup(content) = &hover.contents {
            assert!(
                content.value.contains("The answer to everything"),
                "Should show doc"
            );
        }
    }
    ...
    fn test_hover_impl_method() {
        ...
        if let HoverContents::Markup(content) = &hover.contents {
            ...
            assert!(
                content.value.contains("Does addition"),
                "Should show method doc"
            );
        }
    }
    ...
    fn test_hover_with_param_tags() {
        ...
        if let HoverContents::Markup(content) = &hover.contents {
            assert!(
                content.value.contains("Greets someone"),
                "Should show doc summary"
            );
